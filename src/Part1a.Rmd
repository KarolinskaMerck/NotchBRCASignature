...
# --- Define plan for combining input data
  ...
  #
  # run locally (our system has no connection to the internet, therefore this needs to be run on a local machine)

  if(!file.exists("../data/part1_qnt.ann.rds")){
  
      # --- Add chromosomal annotations to ensembl ids (remove version number)
    qnt.ann = Organism.dplyr::src_organism('TxDb.Hsapiens.UCSC.hg38.knownGene') %>%
    ...
    qnt.ann <- readRDS("~/Projects 2023/notch-project-github-upload/data/part1_qnt.ann.rds")
  }
...
# load TCGA-BRCA, Oslo2 and METABRIC gene universe, saved in "Gene_Universe.rds"
...
saveRDS(ddsSE,
        file = "../results/Training/TNBC_DESeq2.rds")
...
ddsSE <- load("../data/Training/TNBC_DESeq2.rds")
